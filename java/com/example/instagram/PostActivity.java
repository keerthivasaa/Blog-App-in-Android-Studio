...
public class PostActivity extends AppCompatActivity {
    ...
    private void ValidatePostInfo() {
        ...
        if (imageUri==null)
        {
            Toast.makeText(getApplicationContext(),"Please Select A Post Image",Toast.LENGTH_SHORT).show();
        }
        else if (TextUtils.isEmpty(Description))
        {
            Toast.makeText(getApplicationContext(),"Please Write Post Description",Toast.LENGTH_SHORT).show();
        }
        else
        {
